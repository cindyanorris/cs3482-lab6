...
class FileHandler
{
   private:
      ...
      //puts undefined symbols in undefined list (if not already 
      //     defined or already in undefined)
      //puts defined symbols in defined list (if not already in defined 
      //    -- gives multiple definition error for multiple strong symbols) 
      //    and removes from undefined if in undefined
      ...
      //used to check whether an object file in an archive should be 
      //added to the defined and undefined list; that is, does the 
      //object file define something that is currently undefined?
   ...
   public:
      ...
      //a .o should be added to the undefined and defined lists 
      //(by calling objectFileNeeded) 
      //if an object file should be added, it calls handleObjectFile 
      //to do the work 
